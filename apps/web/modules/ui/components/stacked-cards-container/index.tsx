    ...
    case "casual":
      return (
        <div className="group relative">
          ...
          <div className="bg-opacity-70 flex scale-[0.995] flex-col items-center justify-center rounded-xl border border-slate-200 bg-white p-16 backdrop-blur-lg transition-all duration-200 ease-in-out group-hover:scale-[1]">
            {children}
          </div>
        </div>
      );
