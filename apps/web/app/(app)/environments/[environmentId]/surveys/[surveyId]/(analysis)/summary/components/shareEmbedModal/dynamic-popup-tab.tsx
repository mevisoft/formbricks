        ...
        links={[
          {
            ...
            href: "https://example.com/docs/xm-and-surveys/surveys/website-app-surveys/advanced-targeting",
          },
          {
            title: t("environments.surveys.share.dynamic_popup.code_no_code_triggers"),
            href: "https://example.com/docs/xm-and-surveys/surveys/website-app-surveys/actions",
          },
          {
            title: t("environments.surveys.share.dynamic_popup.recontact_options"),
            href: "https://example.com/docs/xm-and-surveys/surveys/website-app-surveys/recontact",
          },
        ]}
      />
    </div>
