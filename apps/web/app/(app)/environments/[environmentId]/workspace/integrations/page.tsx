...
const Page = async (props) => {
  ...
  const integrationCards = [
    {
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/zapier",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/webhooks",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Webhooks",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/google-sheets",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Google Sheets",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/airtable",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Airtable",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/slack",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Slack",
    ...
    {
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/n8n",
    ...
    {
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/make",
      docsText: t("common.docs"),
      docsNewTab: true,
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/notion",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Notion",
    ...
    {
      docsHref: "https://example.com/docs/xm-and-surveys/core-features/integrations/activepieces",
      docsText: t("common.docs"),
      docsNewTab: true,
  ...
  integrationCards.unshift({
    docsHref: "https://example.com/docs/app-surveys/quickstart",
    docsText: t("common.docs"),
    docsNewTab: true,
