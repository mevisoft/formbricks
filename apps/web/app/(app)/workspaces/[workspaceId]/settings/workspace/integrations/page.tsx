...
const Page = async (props: { params: Promise<{ workspaceId: string }> }) => {
  ...
  const integrationCards = [
    {
      docsHref: "https://example.com/docs/platform/features/integrations/zapier",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/platform/features/integrations/webhooks",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Webhooks",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/platform/features/integrations/google-sheets",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Google Sheets",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/platform/features/integrations/airtable",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Airtable",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/platform/features/integrations/slack",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Slack",
    ...
    {
      docsHref: "https://example.com/docs/platform/features/integrations/n8n",
    ...
    {
      docsHref: "https://example.com/docs/platform/features/integrations/make",
      docsText: t("common.docs"),
      docsNewTab: true,
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "https://example.com/docs/platform/features/integrations/notion",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Notion",
    ...
    {
      docsHref: "https://example.com/docs/platform/features/integrations/activepieces",
      docsText: t("common.docs"),
      docsNewTab: true,
