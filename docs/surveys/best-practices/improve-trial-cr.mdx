...
<Note>
  ...
  We assume you’ve already installed the Formbricks Widget in your web app, as it’s required to display messages and surveys. If not, follow the [Quick Start Guide (takes 15 mins max.)](/surveys/website-app-surveys/quickstart).
</Note>
...
Click on **Create Survey** and select the template, [Improve Trial Conversion](https://example.com/survey-templates/improve-trial-conversion):

![Create survey by template](/images/surveys/best-practices/improve-trial-cr/create-survey.webp)

### 2. Optional: Update questions

You can update the questions and answer options.

![Change text content](/images/surveys/best-practices/improve-trial-cr/change-text.webp)

_Want to change the button color? Adjust it in **Settings → Workspace → Appearance**!_
...
![Add page URL action](/images/surveys/best-practices/improve-trial-cr/action-pageurl.webp)
...
![Add inner text action](/images/surveys/best-practices/improve-trial-cr/action-innertext.webp)

Please have a look at our complete [Actions manual](/surveys/website-app-surveys/actions) if you have questions.

### 5. Select Action in the “When to ask” card

![Select feedback button action](/images/surveys/best-practices/improve-trial-cr/select-action.webp)
...
![Set recontact options](/images/surveys/best-practices/improve-trial-cr/recontact-options.webp)

### 7. Congrats! You’re ready to publish your survey 🥳

![Publish survey](/images/surveys/best-practices/improve-trial-cr/publish.webp)
