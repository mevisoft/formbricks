...
<Note>
  ...
  15mins max.)](/surveys/website-app-surveys/quickstart)
</Note>
...
Click on "Create Survey" and choose the template [Churn Survey](https://example.com/survey-templates/churn-survey):

![Create churn survey by template](/images/surveys/best-practices/cancel-subscription/create-cancel-flow.webp)
...
![Change text content](/images/surveys/best-practices/cancel-subscription/change-text.webp)

*Want to change the button color? You can do so in **Settings → Workspace → Appearance**.*
...
![Set the trigger by inner Text](/images/surveys/best-practices/cancel-subscription/trigger-inner-text.webp)
...
![Set the trigger by CSS Selector](/images/surveys/best-practices/cancel-subscription/trigger-css-selector.webp)
...
![Set the trigger by page URL](/images/surveys/best-practices/cancel-subscription/trigger-page-url.webp)
...
![Select feedback button action](/images/surveys/best-practices/cancel-subscription/select-action.webp)
...
![Set recontact options](/images/surveys/best-practices/cancel-subscription/recontact-options.webp)
...
![Publish survey](/images/surveys/best-practices/cancel-subscription/publish-survey.webp)
...
<Note>
  ...
  onwards)](/surveys/website-app-surveys/quickstart) to install the widget.
</Note>
