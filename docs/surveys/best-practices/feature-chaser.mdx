...
<Note>
 Formbricks Widget running? We assume that you have already installed the Formbricks Widget in your web app. It’s required to display messages and surveys in your app. If not, please follow the [Quick Start Guide (takes 15mins max.)](/surveys/website-app-surveys/quickstart)
</Note>
...
Click on "Create Survey" and choose the template [Feature Chaser](https://example.com/survey-templates/feature-chaser):

![Create survey by template](/images/surveys/best-practices/feature-chaser/create-survey.webp)
...
![Change text content](/images/surveys/best-practices/feature-chaser/change-text.webp)
...
You can create [Code Actions](/surveys/website-app-surveys/actions#setting-up-code-actions) and [No Code Actions](/surveys/website-app-surveys/actions#setting-up-no-code-actions) to follow users through your app. In this example, we will create a No Code Action.
...
![Set the trigger by inner Text](/images/surveys/best-practices/feature-chaser/action-innertext.webp)
...
![Set the trigger by CSS Selector](/images/surveys/best-practices/feature-chaser/action-css.webp)

Please follow our [Actions manual](/surveys/website-app-surveys/actions) for an in-depth description of how Actions work.

### 4. Select Action in the “When to ask” card

![Select PMF trigger button action](/images/surveys/best-practices/feature-chaser/select-action.webp)
...
![Set recontact options](/images/surveys/best-practices/feature-chaser/recontact-options.webp)

### 7. Congrats! You’re ready to publish your survey 💃

![Publish survey](/images/surveys/best-practices/feature-chaser/publish.webp)
...
<Note>
  ...
  4 onwards)](/surveys/website-app-surveys/quickstart) to install the widget.
</Note>
