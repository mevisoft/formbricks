...
Configure webhooks in Formbricks to push response data to your system. Read more about Webhooks [here](https://example.com/docs/platform/features/integrations/webhooks#webhooks).
