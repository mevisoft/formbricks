...
<Note>
  Formbricks Widget running? We assume that you have already installed the Formbricks Widget in your web app. It’s required to display messages and surveys in your app. If not, please follow the [Quick Start Guide (15mins)](/surveys/website-app-surveys/quickstart)
</Note>
...
Click on "Create Survey" and choose the template [Interview Prompt](https://example.com/survey-templates/interview-prompt):

![Create interview prompt by template](/images/surveys/best-practices/interview-prompt/create-prompt.webp)

### 2. Update prompt and CTA

Update the prompt, description and button text to match your products tonality. You can also update the button color in **Settings → Workspace → Appearance**.

![Change text content](/images/surveys/best-practices/interview-prompt/change-text.webp)
...
![Add CSS action](/images/surveys/best-practices/interview-prompt/interview-example.webp)
...
In our case, we want to select users who we have assigned the attribute “Power User”. To learn how to assign attributes to your users, please [follow this guide](/surveys/website-app-surveys/user-identification).
...
![Add action](/images/surveys/best-practices/interview-prompt/add-action.webp)
...
![Add page URL action](/images/surveys/best-practices/interview-prompt/action-pageurl.webp)
...
![Add CSS action](/images/surveys/best-practices/interview-prompt/action-css.webp)

![Add inner text action](/images/surveys/best-practices/interview-prompt/action-innertext.webp)

### 5. Select action in the “When to ask” card

![Select feedback button action](/images/surveys/best-practices/interview-prompt/select-action.webp)
...
![Set recontact options](/images/surveys/best-practices/interview-prompt/recontact-options.webp)

### 7. Congrats! You’re ready to publish your survey 💃 🤸

![Publish survey](/images/surveys/best-practices/interview-prompt/publish-survey.webp)

<Note>
 Formbricks Widget running? You need to have the Formbricks Widget installed to display the Feedback Box in your app. Please follow [this tutorial (Step 4 onwards)](/surveys/website-app-surveys/quickstart) to install the widget.
</Note>