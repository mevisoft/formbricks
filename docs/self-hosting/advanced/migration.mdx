...
workspace under **Settings → Organization → Datasets**, or have the integration authenticate as
...
With **Formbricks 3.0**, we're making changes to ensure long-term sustainability while still supporting open source. While the **Community Edition** has gained [new features](https://example.com/blog/formbricks-3-0), some [advanced capabilities](https://example.com/docs/self-hosting/license) are now part of the **Enterprise Edition**.
...
<Info>
  ...
  page](https://example.com/docs/self-hosting/license).
</Info>
...
](https://example.com/docs/developer-docs/rest-api)
