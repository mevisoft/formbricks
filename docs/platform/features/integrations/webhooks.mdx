...
![Step one](/images/platform/features/integrations/webhooks/integrations-tab.webp)
...
Use our documented methods on the **Creation**, **List**, and **Deletion** endpoints of the Webhook API mentioned in our [API v2 playground](https://example.com/docs/api-v2-reference/management-api-%3E-webhooks/get-webhooks).
